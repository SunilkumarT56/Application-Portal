    ...
    <div className='container 2xl:px-4 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
      ...
      <div className='w-full lg:w-1/4 bg-white px-4'>
        ...
        <button
          ...
          className='px-4 py-4 rounded border border-gray-400 lg:hidden'
        >
            ...
            {Array.from({ length: Math.ceil(filteredJobs.length / 6) }).map((_, index) => (
              <a key={index} href="#job-list">
                <button
                  ...
                  className={`w-10 h-10 flex items-center justify-center border border-gray-300 rounded ${currentPage === index + 1 ? 'bg-blue-100' : 'text-gray-500'}`}
                >
                  {index + 1}
                </button>
              </a>
